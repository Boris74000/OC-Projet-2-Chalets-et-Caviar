...
<div class="site-info" <?php if($edge_settings['edge-img-upload-footer-image'] !=''){?>style="background-image:url('<?php echo esc_url($edge_settings['edge-img-upload-footer-image']); ?>');" <?php } ?>>
	<div class="container">
        ...
        <div class="customFooter">
            ...
            <p><a href="https://chalets-caviar.cbd-projects.fr/privacy-policy/">Politique de confidentialité</a></p>
            <p><a href="https://chalets-caviar.cbd-projects.fr/mentions-legales/">Mention légales</a></p>
        </div>
	<?php
